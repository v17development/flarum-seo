...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  app.routes.seo = {
    path: '/seo',
    component: _Pages_HealthCheck__WEBPACK_IMPORTED_MODULE_5__["default"]
  }; // Route to all settings

  app.routes.seoSettings = {
    path: '/seo/settings',
    component: _Pages_SettingsPage__WEBPACK_IMPORTED_MODULE_3__["default"]
  ...
  app.routes.seoSitemap = {
    path: '/seo/sitemap',
    component: _Pages_Sitemap__WEBPACK_IMPORTED_MODULE_4__["default"]
  }; // Registered forum to search engines

  app.routes.seoSearchEngines = {
    path: '/seo/search-engines',
    component: _Pages_RegisterToSearchEngines__WEBPACK_IMPORTED_MODULE_6__["default"]
  }; // Add an secure connection

  app.routes.seoSSL = {
    path: '/seo/ssl',
    component: _Pages_SSLPage__WEBPACK_IMPORTED_MODULE_7__["default"]
...
function (_Page) {
  ...
  _proto.view = function view() {
    return m("div", {
      className: "FlarumSEO"
    }, m(_components_Header__WEBPACK_IMPORTED_MODULE_3__["default"], null), m("div", {
      className: "container"
    }, m("p", {
      className: "seo-intro"
...
function (_Page) {
  ...
  _proto.view = function view() {
    ...
    return m("div", {
      className: "FlarumSEO"
    }, m(_components_Header__WEBPACK_IMPORTED_MODULE_4__["default"], null), m("div", {
      className: "container"
...
function (_Page) {
  ...
  _proto.view = function view() {
    return m("div", {
      className: "FlarumSEO"
    }, m(_components_Header__WEBPACK_IMPORTED_MODULE_2__["default"], null), m("div", {
      className: "container"
...
function (_Page) {
  ...
  _proto.view = function view() {
    return m("div", {
      ...
      className: "container"
    }, m(_components_Forms_SeoSettings__WEBPACK_IMPORTED_MODULE_2__["default"], null)));
  };
...
function (_Component) {
  ...
  _proto.view = function view() {
    ...
    }, 'Health check'), flarum_components_Button__WEBPACK_IMPORTED_MODULE_2___default.a.component({
      className: 'Button',
      onclick: function onclick() {
        return m.route.set(app.route('seoSettings'));
      },
      icon: 'fas fa-cogs'
    }, 'SEO settings'), flarum_components_Button__WEBPACK_IMPORTED_MODULE_2___default.a.component({
      className: 'Button',
      onclick: function onclick() {
        return m.route.set(app.route('seoSitemap'));
      },
      icon: 'fas fa-sitemap'
    }, 'Sitemap information'), flarum_components_Button__WEBPACK_IMPORTED_MODULE_2___default.a.component({
      className: 'Button',
      onclick: function onclick() {
        return m.route.set(app.route('seoSearchEngines'));
      },
      icon: 'fas fa-search'
    }, 'Search engine information'), flarum_components_Button__WEBPACK_IMPORTED_MODULE_2___default.a.component({
      className: 'Button',
      onclick: function onclick() {
