...
/* harmony import */ var flarum_components_Alert__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! flarum/components/Alert */ "flarum/components/Alert");
/* harmony import */ var flarum_components_Alert__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(flarum_components_Alert__WEBPACK_IMPORTED_MODULE_6__);
...
function (_Page) {
  ...
  _proto.view = function view() {
    return m("div", {
      ...
      width: "150"
    }, "Status"))), m("tbody", null, this.forumDescription(), this.siteUsesSSL(), this.discussionPostSet(), this.socialMediaImage(), this.hasSitemap(), this.registeredSearchEngines(), this.robotsTxt(), this.tagsAvailable(), this.reviewAgain()))));
  } // Forum description
  ;
  ...
  _proto.hasSitemap = function hasSitemap() {
    ...
    return m("tr", null, m("td", null, "Your forum has a sitemap available", this.notPassedError(passed, 'It is highly recommended to install the Flagrow sitemap extension!', 'Read more about adding a sitemap', app.route('seoSitemap'))), this.passed(passed));
  ...
  _proto.saveSingleSetting = function saveSingleSetting(setting, value) {
    ...
    var data = {};
    data[setting] = value;
    flarum_utils_saveSettings__WEBPACK_IMPORTED_MODULE_7___default()(data).then(function () {
      app.alerts.show(_this2.successAlert = new flarum_components_Alert__WEBPACK_IMPORTED_MODULE_6___default.a({
        type: 'success',
...
/* harmony import */ var _components_Header__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/Header */ "./src/admin/components/Header.js");
...
function (_Page) {
  ...
  _proto.view = function view() {
    ...
    return m("div", {
      className: "FlarumSEO"
    }, _components_Header__WEBPACK_IMPORTED_MODULE_6__["default"].component(), m("div", {
      className: "container"
...
function (_Page) {
  ...
  _proto.view = function view() {
    return m("div", {
      className: "FlarumSEO"
    }, _components_Header__WEBPACK_IMPORTED_MODULE_4__["default"].component(), m("div", {
      className: "container"
...
/* harmony import */ var _Modals_CrawlPostModal__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../Modals/CrawlPostModal */ "./src/admin/components/Modals/CrawlPostModal.js");
/* harmony import */ var _Modals_RobotsModal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../Modals/RobotsModal */ "./src/admin/components/Modals/RobotsModal.js");
...
function (_Component) {
  ...
  _proto.init = function init() {
    ...
    this.saving = false;
    this.fields = ['forum_title', 'forum_description', 'seo_allow_all_bots'];
    this.values = {};
  ...
  _proto.view = function view() {
    ...
    return m("div", null, this.infoText(), m("form", {
      ...
      children: [m("div", {
        ...
        onclick: function onclick() {
          return app.modal.show(new _Modals_CrawlPostModal__WEBPACK_IMPORTED_MODULE_9__["default"]());
        }
      })]
    }), flarum_components_FieldSet__WEBPACK_IMPORTED_MODULE_2___default.a.component({
      ...
      children: [m("div", {
        ...
        loading: this.saving,
        onclick: function onclick() {
          return app.modal.show(new _Modals_RobotsModal__WEBPACK_IMPORTED_MODULE_10__["default"]());
        }
      }), " ", m("a", {
        href: app.forum.attribute('baseUrl') + "/robots.txt",
        target: "_blank",
...
function (_Modal) {
  ...
  _proto.onsubmit = function onsubmit(e) {
    ...
    flarum_utils_saveSettings__WEBPACK_IMPORTED_MODULE_5___default()(data).then(this.onsaved.bind(this));
...
function (_DashboardWidget) {
  ...
  _proto.content = function content() {
    ...
    }), " It's time to review your SEO settings!", flarum_components_Button__WEBPACK_IMPORTED_MODULE_3___default.a.component({
      className: '',
